...
Is related to fibrous or slender structure, is not a general approximation for all different porous structure ans shapes.
Drag that is function of the canopy depth (canopy flow, flow vegetation)
...
As a concequence of what said above, this method heavily rely on empirical relations.

Gosselin and De Langre in their cases are cheating because in the reconfiguration theory the invested area of the solid became much smaller that the one with the coating filaments not bent; this is why they have reduction in the drag, is a problem in the non-dimensinalization of the body area


\subsection{Homogenization model}
...
\citet{de2008effects} figure 3 spectrum should be discussed

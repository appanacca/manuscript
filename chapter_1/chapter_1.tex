...
The above section introduce the idea to look at the problem as the  approach used to derive a description of the permeable medium in terms of macroscopic quantities
...
The Volume Average Navier-Stokes equations are the homogenization method that we have used in here 
...
Is also worth mention another homogenization based approach that uses mixture theory and show that even within that framework is it possible to retrieve the same equation as VANS or multiple scales \citet{rajagopal2007hierarchy}.

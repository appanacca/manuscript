...
The Cauchy number $C_Y$ define the statical deformation of a solid caused by the fluid flow ($E$ is the modulus of elasticity of the solid material), at Cauchy numbers over the unity important deformation are expected.
...
In figure \ref{fig:cycd} is it possible 

\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{chapter_1/cy_cd}
	\caption{fwrwfr  \citet{de2008effects}}
	\label{fig:cycd}
\end{figure}

...
$$
\tau = \left( \mu + \mu_t \right) \derp{\overline{u}}{y}
$$
...
\citet{heenan1998passive} perform an experiment in which he take a backward facing step with a porous insert in the recirculation region.
...
The effect of the porous surface is to limit the pressure fluctuations that cause the unsteadiness of the recirculation bubble.

The idea has been tested numerically by \citet{bruneau2004passive}, \citet{bruneau2008numerical}, \citet{bhattacharyya2011reduction}, \citet{naito2012numerical}.
These works use some classical two dimensional bluff bodies (cylinder, square cylinder, ahmed body section) and apply a porous coatings on their surfaces.
They show that even of the porous medium is rigid the flow field downstream to the object is strongly regularized as figure \ref{fig:porous_cylinder} show.
...
Also they compute regularization in the root mean square of the lift signal and some very promising drag reduction.
...
Penalization method \cite{bruneau2004passive} \cite{bruneau2008numerical} \cite{bruneau2010coupling}

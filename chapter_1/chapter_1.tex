...
\citet{itoh2006turbulent} and  shows that compliant wall can outperform riblets.

Compliant, surfaces that deflect in response to the surface pressure fluctuation of the boundary layer
by responding to the pressure fluctuations
across the surface, a compliant material on the surface of an object in a fluid flow
has been shown to be beneficial. Though early studies showed dramatic drag-
reduction benefits, later studies have only been able to confirm 7 per cent drag
reduction (Choi et al. 1997).

i delfini hanno una pelle compliant e agiscono sulla transizione alla turbolenza

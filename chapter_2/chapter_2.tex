...
\section{Conclusions}
We have shown in this chapter how to formally derive the homogenized version of the Navier-Stokes equations. We have also discussed the extension of the model in case of elastic porous medium. A lot of focus has been put on the closure problem for the microscopic force since the topic is further developed in chapter 4.
Although the average volume method is not a new method we think that this review help to organize the newest works in literature and can form a basis for better understand the next chapters.

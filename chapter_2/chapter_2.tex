...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{chapter_2/figure/schema_vans_homo}
	\caption{Illustration of the homogenization procedure. Image from \citet{davit2013homogenization}}

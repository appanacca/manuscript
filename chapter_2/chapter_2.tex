...
However even if the local closure problems are not formally correct at the interface
However if the local formulation of the closure problem is used to solve the macroscopic equations in the interface region
However in the last chapter we show that good results can still be achieved using the same closure problems.

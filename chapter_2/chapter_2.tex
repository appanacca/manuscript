...
After the proper simplification we have the final versions of the Navier-Stokes system of equations using intrinsic quantities:
...
One crucial difference between the superficial and the intrinsic equations is in the continuity equations; in fact only the superficial velocity field is solenoidal.

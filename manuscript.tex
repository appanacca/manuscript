...
\def\means#1{{\left< #1 \right>}^{s}} %\mean{.} superficial average operator
\newcommand{\vb}{\textbf{v}_{\beta}} %\vb velocity in the fluid
\newcommand{\vbt}{\tilde{\textbf{v}}_{\beta}} %\vbt spatial fluctuation velocity in the fluid
...
\newcommand{\rhos}{\rho_{\sigma}} %\rob density of fluid phase
...
%\includeonly{capitoli/7/capitolo_7} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

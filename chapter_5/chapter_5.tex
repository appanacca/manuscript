...
In our simulations the effective permeability is constant, in the sense that the metamodel for the effective permeability has not been applied.  As a matter of fact the metamodel in chapter \ref{ch:4} was built for a porous medium made of staggered cylinders. So it would not be applicable in this case in which the porous medium is made by regular arranged cylinders.
...
A direct comparison of the metamodel variation on the macroscopic field would be presented in the paragraph \ref{pr:mata_cav}.
...
\subsection{Comparison in the unstable regime}

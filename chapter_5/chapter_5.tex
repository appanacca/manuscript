...
The treatment for the porosity is the same as equation \eqref{eq:porsitity_fun} where in this case the $y_itf$ id described by the Gaussian function \eqref{eq:gaussian}.

...
with the perturbation velocity components which vanish when $y=0$ and $y=y_{\infty}$. The upper boundary
...
integration domain.
The stability results (for the same parameters as in \ref{fig:2}) are displayed in \ref{fig:6}. 
